...
@property (nonatomic, strong, readonly) NSURL *URL; /**< NSURL instance that contains a full request
                                                         URL with signed parameters. This property
                                                         is lazily initialized and remains nil until
                                                         request object gets 'send' message.*/
@property (nonatomic, strong)   NSDictionary *additionalParameters; /**< Subclasses can override this implementation
                                                                         to add custom parameters to requests */
@property (nonatomic, strong, readonly) NSDictionary *signedParameters; /**< Dictionary of base request parameters as well
                                                                             as necessary request signatures. This property
                                                                             is lazily initialized and remains nil until
                                                                             request object gets 'send' message. */
@property (nonatomic, unsafe_unretained)   int hashCode;      /**< Unique hash code identifying this request. Used by the Unity3d plugin */

@property (nonatomic, weak)   id<PHAPIRequestDelegate>  delegate; /**< Request delegate, see PHAPIRequestDelegate */
