    ...
    return
        [KIFTestStep stepWithDescription:@"Tapping an element in a webview"
                          executionBlock:^KIFTestStepResult(KIFTestStep *step, NSError *__autoreleasing *error) {
                              ...
                              NSData *positionResultData = [positionResult dataUsingEncoding:NSUTF8StringEncoding];
                              NSDictionary *positionDictionary = positionResultData ? [NSJSONSerialization JSONObjectWithData:[positionResult dataUsingEncoding:NSUTF8StringEncoding] options:0 error:nil] : nil;
