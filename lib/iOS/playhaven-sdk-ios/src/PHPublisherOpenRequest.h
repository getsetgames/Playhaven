 ...
 **/
@interface PHPublisherOpenRequest : PHAPIRequest <CLLocationManagerDelegate> {
}
...
/**
 * Returns a new PHPublisherOpenRequest instance with the given token and secret
 *
 * @param token
 *   The token
 *
 ...
 *
 * @param delegate
 *   A PHAPIRequestDelegate
 *
 * @return
 *   The PHPublisherOpenRequest instance
 **/
