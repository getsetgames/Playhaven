...
+ (id)contentWithDictionary:(NSDictionary *)dictionaryRepresentation
{
    ...
    if (shouldCreateInstance) {
        ...
        if ([dictionaryRepresentation objectForKey:@"video_template_url"]) {
            result.videoOverlayURL = [NSURL URLWithString:[dictionaryRepresentation objectForKey:@"video_template_url"]];
        }
