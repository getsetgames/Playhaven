...
@property (nonatomic, strong)    NSString       *placement;               /**< Placement id for this content request, this should correspond to one of the
                                                                              placements set up for this game on the PlayHaven Dashboard */
@property (nonatomic, unsafe_unretained)    BOOL            animated;                /**< Controls whether content unit transitions will be animated for this request */
@property (nonatomic, readonly)  NSMutableArray *contentViews;            /**< Collection of PHContentViews being managed by this request */
@property (nonatomic, unsafe_unretained)   BOOL            showsOverlayImmediately; /**< Controls whether or not the overlay will be shown immediately after PHAPIRequest#send.
                                                                              Defaults to NO */
@property (nonatomic, readonly) UIView         *overlayWindow;           /**< Overlay view instance */

@property (nonatomic, weak) id<PHPublisherContentRequestDelegate> delegate;
