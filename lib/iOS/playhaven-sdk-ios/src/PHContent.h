...
@property (nonatomic, strong) NSURL         *URL;                 /**< Content template URL */
@property (nonatomic, strong) NSDictionary  *context;             /**< Content unit context object, this is what is sent to the
                                                                       content template after a ph://loadContext dispatch */
@property (nonatomic, unsafe_unretained) NSTimeInterval closeButtonDelay;    /**< Amount of time (in seconds) to wait after displaying the
...
@property (nonatomic, unsafe_unretained) PHContentTransitionType transition; /**< Transition type, see PHContentTransitionType above */

@property (nonatomic, assign) NSInteger             creativeId;           /**< ID of the video to play */
@property (nonatomic, strong) NSURL                 *videoOverlayURL;     /**< Content template for video UI overlay */
