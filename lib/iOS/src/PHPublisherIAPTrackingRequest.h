...
@property (nonatomic, unsafe_unretained) NSInteger quantity;    /**< The total quantity purchased for this IAP transaction */
@property (nonatomic, strong) NSError  *error;       /**< The error encountered by this request, if applicable */
@property (nonatomic, strong) NSData   *receiptData; /**< iTunes transaction receipt data for this transaction */
@property (nonatomic, unsafe_unretained) PHPurchaseResolutionType resolution; /**< The resolution of this transaction (buy, cancel, error) */
@end
#endif
