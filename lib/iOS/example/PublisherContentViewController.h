...
@property (nonatomic, strong) IBOutlet UITextField *placementField;
@property (nonatomic, strong) IBOutlet UISwitch    *showsOverlaySwitch;
@property (nonatomic, strong) IBOutlet UISwitch    *animateSwitch;
@property (nonatomic, strong) IBOutlet UISwitch    *forceVideo;
@property (nonatomic, strong) PHPublisherContentRequest *request;
