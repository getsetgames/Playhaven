...
@property (nonatomic, weak) id<PHURLLoaderDelegate> delegate; /**< The delegate, see PHURLLoaderDelegate for supported methods */
@property (nonatomic, strong) NSURL *targetURL;                 /**< The target URL, will be updated as redirects are followed */
@property (nonatomic, unsafe_unretained) BOOL   opensFinalURLOnDevice;     /**< Controls whether or not targetURL will be opened on the device. Default \c YES */
@property (nonatomic, strong) id     context;                   /**< Context object. Often used to pass along callback information for dispatches. Default nil \c */
