...
@interface PHNotificationViewTest : XCTestCase
@end

@interface PHNotificationViewDeallocTest : XCTestCase {
...
- (void)testInstance
{
    ...
    XCTAssertNotNil(notificationView, @"expected notification view instance, got nil");
    XCTAssertTrue([notificationView respondsToSelector:@selector(refresh)], @"refresh method not present");
}
@end
