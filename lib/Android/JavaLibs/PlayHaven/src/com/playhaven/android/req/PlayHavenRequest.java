...
public abstract class PlayHavenRequest
{
     ...
     */
    public static String ifa = null;

    public PlayHavenRequest()
    {
        // Default
        identifiers = new HashSet<Identifier>();
        identifiers.add(Identifier.AdvertiserID);
    ...
    protected String createHmac(SharedPreferences pref, String content, boolean stripEquals) throws NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException {
        return createHmac(pref, content, getString(pref, Secret), stripEquals);
    }

    public static String createHmac(SharedPreferences pref, String content, String secret, boolean stripEquals) throws NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException {
        SecretKeySpec key = new SecretKeySpec(secret.getBytes(PlayHaven.getUTF8()), HMAC);
